$( document ).ready(function() {
	$(".category-navigation .container ul.level-0 > li > a:contains('PINK DAY')").css("background","#f238a6");
	$(".category-navigation .container ul.level-0 > li > a:contains('PINK DAY')").css("color","#003259");
	$(".category-navigation .container ul.level-0 > li > a:contains('PINK DAY')").attr("href","http://www.FOApinkday.com");
